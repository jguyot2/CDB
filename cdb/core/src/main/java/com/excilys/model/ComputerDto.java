...
public final class ComputerDto {
	...
	public boolean equals(final ComputerDto other) {
		...
		return Objects.equals(this.name, other.name) && Objects.equals(this.discontinued, other.discontinued)
				&& Objects.equals(this.introduced, other.introduced) && Objects.equals(this.company, other.company);
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.name, this.discontinued, this.introduced, this.company);
	}
