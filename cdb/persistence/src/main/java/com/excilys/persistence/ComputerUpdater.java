...
/**
 * Classe permettant d'effectuer des mises à jour sur les éléments de la table computer à partir d'instances
 * de Computer.
 *
 * @author jguyot2
 */
...
public class ComputerUpdater {
      ...
      *
      * @return le nouvel identifiant correspondant à la ligne ajoutée si l'ajout a réussi, 0 si l'ajout a
      *         raté
      */
      ...
      */
     @Transactional(rollbackFor = PersistanceException.class)
     public int deleteById(final Long... identifiers) throws PersistanceException {
          try {
