...
/**
 * Interface forçant à utiliser les mêmes noms de méthodes pour les diverses classes de recherche (i.e qui
 * recherchent des objets/informations dans la base)
 *
 * @author jguyot2
 *
...
interface Searcher<T> {
     ...
     * @throws SQLException
     */
    List<T> fetchList() throws DaoException;
     ...
     * @throws SQLException
     */
    List<T> fetchList(Page p) throws DaoException;
     ...
     * @throws SQLException
     */
    int getNumberOfElements() throws DaoException;
}
