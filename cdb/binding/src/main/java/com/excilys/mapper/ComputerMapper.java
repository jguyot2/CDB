...
public final class ComputerMapper {
      ...
      * @param dtoComputer
      *
      * @return un Optional contenant la valeur de Computer associée au DTO si ce dernier est cohérent (=les
      *         identifiants sont bien des nombres, et le nom n'est pas vide).
      */
      ...
      *
      * @return un optional contenant l'ordinateur associé au DTO, avec l'attribut "manufacturer" égal au
      *         second paramètre (pouvant être nul), ou un Optional vide si les valeurs du DTO sont
      *         incohérentes.
      */
