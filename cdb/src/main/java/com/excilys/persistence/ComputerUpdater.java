...
public class ComputerUpdater {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(ComputerUpdater.class);
     ...
     *
     * @param newComputer l'instance de Computer à enregistrer
     *                    dans la base de
     *                    données
     *
    ...
    public long createComputer(final Computer newComputer) throws SQLException {
        ...
        try (PreparedStatement stmt = DBConnection.getConnection()
                .prepareStatement(CREATE_COMPUTER,
                        PreparedStatement.RETURN_GENERATED_KEYS)) {

            stmt.setString(1, newComputer.getName());

            Optional<java.sql.Date> introDateOpt = DateMapper
                    .localDateToSqlDate(newComputer.getIntroduction());
            ...
            Optional<java.sql.Date> discoDateOpt = DateMapper
     ...
     * est intialisé.
     *
     * @param newComputer la valeur de l'ordinateur à laquelle
     *                    on veut faire
    ...
    public int updateComputer(final Computer newComputer) throws SQLException {
        LOG.info("Mise à jour de l'instance de Computer suivante "
