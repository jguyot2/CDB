...
public class EditComputerController {
	...
	@PostMapping
	public String editcomputer(@RequestParam(name = "computerName") final String computerName,
		...
		try {
			ComputerDto c = new ComputerDto(computerName, computerId, (CompanyDto) null, introduced, discontinued);
			...
			if (isComputerEdited == 0) {
				...
				return "redirect:/page?message=" + UrlEncoding.encode("L'ordinateur a bien été mis à jour");
			}
	 ...
	 */
	@GetMapping
	public String getToEditPage(@RequestParam(name = "id") final Long computerId, @NonNull final Model m) {
