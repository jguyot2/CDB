package com.excilys.restcontrollers.security;
		...
		if (requestTokenHeader != null) {
			if (requestTokenHeader.startsWith("Bearer ")) {
				...
				try {
					...
					response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Signature issue");
					return;
				} catch (PrematureJwtException e) {
					response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Premature token");
					return;
