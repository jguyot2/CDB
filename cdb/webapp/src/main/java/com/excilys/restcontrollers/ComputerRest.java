...
public class ComputerRest {
	...
	public ResponseEntity<String> editcomputer(@RequestBody final ComputerDto c, @NonNull final Model m) {
	...
	public ResponseEntity<String> showPage(final Page page, @RequestParam(required = false) final String search,
