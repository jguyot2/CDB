...
public class ComputerValidator {
	...
	public void validate(@Nullable final Computer instance) throws InvalidComputerException {
		checkComputerValidity(instance);
	}

	private void checkCompany(@NonNull final Computer c, final List<ComputerProblems> problems) {
	...
	private void checkComputerValidity(@Nullable final Computer computer) throws InvalidComputerException {
		if (computer == null) {
